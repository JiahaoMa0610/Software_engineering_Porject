...
public class Test5 {
  ...
  public void test5() throws Exception {
    ...
    driver.findElement(By.name("uname")).sendKeys("jiahao");
    driver.findElement(By.name("psw")).click();
    driver.findElement(By.name("psw")).clear();
    driver.findElement(By.name("psw")).sendKeys("teamawesome");
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Username'])[1]/following::button[1]")).click();
  }
